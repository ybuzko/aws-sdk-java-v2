...
import software.amazon.awsssdk.encryption.s3.internal.DefaultS3EncryptionClient;
...
public interface S3EncryptionClient extends S3Client {
    ...
    static Builder builder(EncryptionPolicy encryptionPolicy) {
        return DefaultS3EncryptionClient.builder(encryptionPolicy);
    }

    /**
     * Create an {@link S3EncryptionClient.Builder} using configuration copied from the provided runtime.
     */
    static Builder builder(S3EncryptionRuntime runtime) {
        return DefaultS3EncryptionClient.builder(runtime);
    }
