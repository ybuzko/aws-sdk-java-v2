...
import software.amazon.awsssdk.encryption.s3.internal.DefaultS3EncryptionRuntime;
 ...
 * data streams.
 */
public interface S3EncryptionRuntime extends ToCopyableBuilder<S3EncryptionRuntime.Builder, S3EncryptionRuntime>,
                                             SdkAutoCloseable {
    /**
    ...
    static Builder builder(EncryptionPolicy encryptionPolicy) {
        return DefaultS3EncryptionRuntime.builder(encryptionPolicy);
    }
    ...
    interface Builder extends CopyableBuilder<Builder, S3EncryptionRuntime> {
        /**
