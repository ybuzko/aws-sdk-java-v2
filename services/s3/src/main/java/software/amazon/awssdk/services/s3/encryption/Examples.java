...
import static software.amazon.awssdk.services.s3.encryption.content.ContentEncryptionAlgorithm.NOT_ENCRYPTED;
...
import software.amazon.awssdk.services.s3.encryption.content.ContentEncryptionAlgorithm;
    ...
    public static void main(String... args) {
        ...
        EncryptionPolicy customPolicy =
            EncryptionPolicy.builder()
                            .allowedKeyWrapAlgorithms(KeyWrapAlgorithm.KMS)
