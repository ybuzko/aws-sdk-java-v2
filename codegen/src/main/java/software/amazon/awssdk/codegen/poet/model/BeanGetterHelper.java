...
public final class BeanGetterHelper {
    ...
    private MethodSpec listOfMapOfBuilderGetter(MemberModel memberModel) {
        ...
        CodeBlock mapReturnStatement = CodeBlock.of("Collectors.toMap(entry -> entry.getKey(), "
                                                    + "entry -> entry.getValue().toBuilder())");
        ...
        MethodSpec methodSpec = basicGetter(memberModel, returnType, returnStatement);
        return methodSpec;
    }
