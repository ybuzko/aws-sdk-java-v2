...
public class HttpChecksumRequiredTest {
    ...
    public void setup() throws IOException {
        ...
        jsonClient = ProtocolRestJsonClient.builder().httpClient(httpClient).build();
        jsonAsyncClient = ProtocolRestJsonAsyncClient.builder().httpClient(httpAsyncClient).build();
        xmlClient = ProtocolRestXmlClient.builder().httpClient(httpClient).build();
        xmlAsyncClient = ProtocolRestXmlAsyncClient.builder().httpClient(httpAsyncClient).build();
